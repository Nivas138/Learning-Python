...
def main():
    encoded = """
      jvplh lczff vaync kilyr jmass ygtav lvncs
      hxzcc uptys lrepf alpes exjzi dsfwr smvph
      viync kiess ugcpo aijzi ygtav lvmjh fttyu
      hgslf hgepf ascpd senps hgszh oicnv hvlnh
      lvhth oglds ziydo amgph oiepl afzio axspp
      vxeza dmwwo bxzxo amnlz scmpf ltwlq lhhth
      oczff lrnzr lhxpg zerp"""
    english_frequences = [
